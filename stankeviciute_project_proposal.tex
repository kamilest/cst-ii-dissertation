...
One reason why such graph representation is considered to be useful in the  population context is that it makes use of both the features of individuals (node feature vectors) and the trends in the population through pairwise similarities (graph edges), inferring the information about  label from their neighbourhood.
...
\begin{itemize}
  \item \textit{Deliverable}: The data is preprocessed into features and is ready for analysis. % [Tiago] "data cleaned and is ready for analysis" 
