...
\begin{table}[]
    ...
    UKB preprocessing 
            ...
            & \texttt{ukb\_preprocess.py} & See Section~\ref{section:ukb-preprocessing}. \\
            & \texttt{ukb\_preprocess\_test.py} &  Tests for similarity matrix code. \\ \hline
    Graph construction
            & \texttt{graph\_construct.py} &See Section~\ref{section:graph-construction}.\\
            & \texttt{graph\_construct\_test.py} & Tests for correctness of example population graphs. \\ \hline
