...
\subsection{Testing}
Following the requirement R1 for this project (see Section~\ref{section:requirements-analysis}), it is important to ensure that the data is preprocessed correctly. This component has an additional unit testing module to ensure that the similarity matrices are computed correctly. Functional connectivity matrices use a well-tested third-party library. 
