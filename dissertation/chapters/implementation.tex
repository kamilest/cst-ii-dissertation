...
This project is based around central pipeline which 
\begin{enumerate}
...
This chapter will provide the overview of this pipeline and then explain in increasing detail the steps behind each one of the pipeline stages.
