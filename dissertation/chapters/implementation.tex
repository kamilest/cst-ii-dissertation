...
TODO I just thought, one good point towards modularity is what pietro once said about one of your contributions: that you are building a generic pipeline for analysis, thus easy to extend each component in separate, etc. Even if you don't mention modularity specifically, you can mention this contribution and important feature of your project (I think it was in some extension idea)
...
TODO you mention somewhere in the preparationg section tht in Implementation you will show the good software pratices. One or 2 sentences here with a general overview would probably help in giving a general idea of your implementtion as not only a bunch of components put together, but a thoughtful, modular, etc etc project
The work was split into these particular components so that each of them can carry out a single task independently of the other parts of the program, other than the clearly defined input/output communication. This makes the overall project easier to implement, understand and extend in the future. 
