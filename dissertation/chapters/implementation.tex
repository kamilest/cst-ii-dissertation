...
As a result, many (if not most) hyperparameter combinations caused the model to run out of GPU memory. In practice, the models were limited to up to 8 gigabytes of memory. This led to the hyperparameter constraints:
