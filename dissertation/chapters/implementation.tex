...
The proposed extension for the training and evaluation component was to evaluate the \textit{robustness} of the GNN models to the noise in the population graph, measured by the rate of performance drop with increased noise. 

One motivation for this is the MRI scan data being noisy~\cite{pervaiz2020optimising,niu2019improved}, in which case the neighbourhood information might potentially help to correct the prediction for a node with noisy data. This type of robustnes
