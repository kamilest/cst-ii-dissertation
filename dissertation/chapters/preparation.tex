...
of which (due to symmetry and the non-informative diagonal) only the flattened lower triangle is usually taken in the machine learning implementations.
