...
the model is trained only on healthy subjects, $f(\cdot)$ will still learn the brain age even with the chronological age label, since for healthy subjects $y_b \approx e_c$. 
