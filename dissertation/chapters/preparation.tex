...
This project will use \textit{PyTorch Geometric}~\cite{fey2019pytorch}, an extension library for \textit{PyTorch}~\cite{pytorch} that implements a variety of graph neural network architectures. The library is supported in Python, which will be the implementation language of this project. 
...
The preprocessed dataset has been kindly provided by Dr Richard A.I. Bethlehem of Department of Psychiatry.