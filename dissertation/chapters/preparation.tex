...
\begin{figure}[]
    ...
    \caption{Axial slices of the T1 (top) and T2-weighted FLAIR MRI images of a brain. Left to right: the view from the side, front, and top of the brain.}\label{figure:t1-t2}
\end{figure}
...
\begin{figure}[]
    ...
    \caption{An example BOLD time-series for a single brain region, showing fluctuations in relative units.}\label{figure:fmri}
\end{figure}
...
\begin{figure}[h!]
    \centering
    \includegraphics[width=0.6\textwidth]{parcellated_brain.pdf}
    \caption{Axial slices of an MRI image of a brain (left to right: from the side, from the top, from the back), with parcels highlighted in different colours.}\label{figure:parcellated-brain}
\end{figure}
