...
The purpose of phenotype data is to define the inter-subject similarity score (described below), which will determine the edges in the population graph. The full list of features that were used to define similarity metrics is provided in the Appendix.
