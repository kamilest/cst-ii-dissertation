...
In this dissertation, the phenotype (non-imaging) data refers to all subject data that does not come from MRI scans. The features related to this project include the subject's sex, the psychiatric disorder diagnoses, mental health status, education, among others.

TODO Link phenotype data to literature on confounding!
The purpose of phenotype data is to compute the inter-subject similarity score, which will determine the edges of the population graph.
