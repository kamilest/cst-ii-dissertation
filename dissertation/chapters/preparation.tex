...
To track the workflow, prevent loss of data and ease the readability and/or any future extensions to this project, the common practices of consistent code style (adhering to PEP8\footnote{\url{https://www.python.org/dev/peps/pep-0008/}} style guide), comprehensive documentation, unit testing, design patterns, version control (through a \texttt{git} repository), backup strategies (regular backups to an external disk, GitHub repository, Google Drive), and code reuse will be applied.
