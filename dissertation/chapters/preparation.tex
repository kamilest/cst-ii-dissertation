...
% TODO connection between the subject set S and vertex set V through S_v or something
...
Labels are available for a small subset of nodes and are spread across neighbourhoods through a regularisation term such as Laplacian \cite{kipf2017semi}
