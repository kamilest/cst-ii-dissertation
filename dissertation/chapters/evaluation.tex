...
looking at the results draw in things that were ticked off in plan
...
Parisot paper has state-of-the-art results using this technique, but it didn't work (yet) for the age prediction task—it is out of scope of this dissertation to find the explanation for this
